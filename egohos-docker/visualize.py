...
if __name__ == '__main__':
    ...
    for img_file in glob.glob(args.img_dir + '/*'):
        ...
        if args.mode == 'twohands':
            ...
            twohands_vis = twohands_vis.astype(dtype=np.uint8)
            ...
            cb_vis = cb_vis.astype(dtype=np.uint8)
            ...
            twohands_obj1_vis = twohands_obj1_vis.astype(dtype=np.uint8)
            ...
            twohands_obj2_vis = twohands_obj2_vis.astype(dtype=np.uint8)
