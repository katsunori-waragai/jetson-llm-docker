...
filename = Path("captured/01/tmp.jpg"  を入力ファイルとして

```
Traceback (most recent call last):
  File "predict_capture.py", line 55, in <module>
  ...
  File "/root/EgoHOS/mmsegmentation/mmseg/models/segmentors/encoder_decoder.py", line 419, in whole_inference
    seg_logit = self.encode_decode(img, img_meta)
  File "/root/EgoHOS/mmsegmentation/mmseg/models/segmentors/encoder_decoder.py", line 126, in encode_decode
    aux = Image.open(aux_file); aux_w, aux_h = aux.size[0], aux.size[1]
  File "/usr/local/lib/python3.8/dist-packages/Pillow-9.4.0-py3.8-linux-aarch64.egg/PIL/Image.py", line 3227, in open
    fp = builtins.open(filename, "rb")
FileNotFoundError: [Errno 2] No such file or directory: 'captured/pred_twohands/tmp.png'
```
